...
import { PermissionaryDetailComponent } from './permissionary-detail/permissionary-detail.component';
...
export class PermissionariesComponent implements OnInit {
  ...
  detailPermissionary(permissionary){
    this.dialog.open(PermissionaryDetailComponent, {
      data : permissionary,
      width : "98%"
    })
  }
